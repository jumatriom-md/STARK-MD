...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "25706106326", // Only 1 owner number here, others add to sudo numbers
    OWNER_NAME: process.env.OWNER_NAME || "TRAILER JAIT8ON ", // Custom name
    ...
    TIME_ZONE: process.env.TIME_ZONE || "Africa/Kampala", // Enter your timezone
};
